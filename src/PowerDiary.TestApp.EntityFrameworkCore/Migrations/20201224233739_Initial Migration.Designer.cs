...
namespace PowerDiary.TestApp.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20201224233739_Initial Migration")]
            ...
            modelBuilder.Entity("PowerDiary.TestApp.Core.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 12, 24, 23, 37, 39, 199, DateTimeKind.Utc).AddTicks(5735),
                            IsActive = true,
                            Username = "Bob"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2020, 12, 24, 23, 37, 39, 199, DateTimeKind.Utc).AddTicks(6678),
                            IsActive = true,
                            Username = "Kate"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2020, 12, 24, 23, 37, 39, 199, DateTimeKind.Utc).AddTicks(6682),
                            IsActive = true,
                            Username = "Alice"
                        },
                        new
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2020, 12, 24, 23, 37, 39, 199, DateTimeKind.Utc).AddTicks(6683),
                            IsActive = true,
                            Username = "John"
                        });
                });
